...
public:
    IkdTreeLoopClosureDetector(core::IScanMatcher::SharedPtr scan_matcher,
                               const IkdTreeLoopClosureDetectorParams& params);
...
private:
    ...
    core::IScanMatcher::SharedPtr scan_matcher_;
